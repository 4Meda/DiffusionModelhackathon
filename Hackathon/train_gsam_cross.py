...
if args.optim == 'sgd':
    ...
    # base_optimizer = torch.optim.SGD(model.parameters(), lr=args.lr_max, momentum=args.momentum, weight_decay=args.weight_decay)
    #base_optimizer = Theopoula.THEOPOULA(model.parameters(),eps=1e-1, lr=args.lr_max,weight_decay=args.weight_decay, beta=1e12, eta=5e-4, r=0)
...
for epoch in range(args.total_epoch):
    ...
    if epoch>99 and epoch % 10 == 0:   
        model_path = 'ckpts/adamw/model_{}.pth'.format(epoch)
